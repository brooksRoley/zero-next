...
- [ ] **Step 2: Confirm current test count green**
...
- [ ] **Step 3: Create the zones module**
...
- [ ] **Step 4: Update basketball-platform.jsx to import zones**
...
- [ ] **Step 5: Run tests + verify page still renders**
...
- [ ] **Step 1: Create the setup endpoint (admin-gated)**
...
- [ ] **Step 3: Update engine-bridge return type + logic**
...
- [ ] **Step 4: Update monte-carlo.ts to pass playerLines through**
...
- [ ] **Step 3: Implement the season simulator**
...
- [ ] **Step 3: Write the backtest script**
...
- [ ] **Step 4: Write the activate script**
...
## Test plan
- [ ] Run `GET /api/nba/tft/setup` (admin-gated) on a preview deployment to create tables
- [ ] Run `yarn tft:backtest --generations 20` locally (quick sanity fit)
- [ ] `yarn tft:activate <version>` to promote
- [ ] Reload `/basketball-platform` — case-study section shows scorecard + residuals
- [ ] Verify shot heatmap renders side-by-side for a real player in the backtest
EOF
)"
```
